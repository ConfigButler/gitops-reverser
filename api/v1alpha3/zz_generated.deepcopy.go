...
func (in *ClusterResourceRule) DeepCopyInto(out *ClusterResourceRule) {
	*out = *in
	...
	if in.ExcludeFieldManagers != nil {
		in, out := &in.ExcludeFieldManagers, &out.ExcludeFieldManagers
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitTargetDestination) DeepCopyInto(out *GitTargetDestination) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitTargetDestination.
func (in *GitTargetDestination) DeepCopy() *GitTargetDestination {
	if in == nil {
		return nil
	}
...
func (in *GitTargetStatus) DeepCopyInto(out *GitTargetStatus) {
	*out = *in
	if in.ObservedDestination != nil {
		in, out := &in.ObservedDestination, &out.ObservedDestination
		*out = new(GitTargetDestination)
		**out = **in
	}
	if in.Conditions != nil {
