...
func (in *ClusterWatchRuleStatus) DeepCopyInto(out *ClusterWatchRuleStatus) {
	*out = *in
	...
	if in.Streams != nil {
		...
		*out = new(WatchRuleStreamsStatus)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *GitTargetStreamsStatus) DeepCopy() *GitTargetStreamsStatus {
	if in == nil {
		return nil
	}
	out := new(GitTargetStreamsStatus)
...
func (in *WatchRuleStreamsStatus) DeepCopy() *WatchRuleStreamsStatus {
	if in == nil {
		return nil
	}
	out := new(WatchRuleStreamsStatus)
