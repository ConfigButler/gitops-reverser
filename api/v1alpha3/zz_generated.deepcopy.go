...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitTargetPlacementClass) DeepCopyInto(out *GitTargetPlacementClass) {
	*out = *in
	if in.ByType != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitTargetPlacementClass.
func (in *GitTargetPlacementClass) DeepCopy() *GitTargetPlacementClass {
	if in == nil {
		return nil
	}
	out := new(GitTargetPlacementClass)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GitTargetPlacementSpec) DeepCopyInto(out *GitTargetPlacementSpec) {
	*out = *in
	in.Sensitive.DeepCopyInto(&out.Sensitive)
	in.Normal.DeepCopyInto(&out.Normal)
}
