...
func (in *ClusterProviderReference) DeepCopy() *ClusterProviderReference {
	if in == nil {
		return nil
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitTargetPlacementExample) DeepCopyInto(out *GitTargetPlacementExample) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitTargetPlacementExample.
func (in *GitTargetPlacementExample) DeepCopy() *GitTargetPlacementExample {
	if in == nil {
		return nil
	}
	out := new(GitTargetPlacementExample)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GitTargetPlacementStatus) DeepCopyInto(out *GitTargetPlacementStatus) {
	*out = *in
	...
	if in.Examples != nil {
		...
		*out = make([]GitTargetPlacementExample, len(*in))
		copy(*out, *in)
	}
}
