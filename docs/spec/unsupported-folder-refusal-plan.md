...
> [e2e-coverage-gaps-and-improvements-plan.md §4.1](../design/e2e-coverage-gaps-and-improvements-plan.md): the
...
> [status-design-git-target.md](status-conditions-guide.md).
