...
>
> Scope update: see
> [subresource-scope-reduction.md](scale-subresource-audit-rehydration.md). Future work
...
> see [subresource-scope-reduction.md](scale-subresource-audit-rehydration.md). Only
...
[subresource-scope-reduction.md](scale-subresource-audit-rehydration.md)). The shipped
