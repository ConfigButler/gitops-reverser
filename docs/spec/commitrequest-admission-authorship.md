...
[commitrequest-attribution-divert-reliability.md](commitrequest-admission-authorship.md),
...
admission-captured commands ([redis-key-schema-v3.md](../finished/redis-key-schema-v3.md)).
...
- **Easy route (chart + config).** The Helm chart and the `config/` kustomize overlay
  ...
  certs instead. See [audit-webhook-tls-design.md](../finished/audit-webhook-tls-design.md) for the
