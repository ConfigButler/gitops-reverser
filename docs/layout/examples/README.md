...
Two fields are proposed as new members of the `spec.placement` the current release already has —
placement concerns, grouped with the rest of the placement axis. Everything else in these scenarios
ships today.
