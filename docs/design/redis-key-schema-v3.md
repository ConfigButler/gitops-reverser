...
> [CommitRequest authorship from admission](commitrequest-admission-authorship.md),
> [deletecollection attribution & deletion-as-intent](deletecollection-attribution-expander.md),
