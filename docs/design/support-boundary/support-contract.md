...
>
> Status: the front door for this workstream. Captured 2026-07-11.
> Every other doc in this folder argues *for* one of the verdicts below; this page
> only states them. If a claim here and a claim there disagree, this page is wrong
> and should be fixed — the boundary has one home now.
...
| Argo CD `Application` generated by an `ApplicationSet` | expansion | **Not mirrored** | carries an `ownerReference`; no home file |
...
| `Secret` derived by ESO / sealed-secrets | expansion → **Not mirrored** | carries an `ownerReference` |
