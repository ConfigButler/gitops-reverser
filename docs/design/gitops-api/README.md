...
| **Architecture** | [the-layer-above-and-the-expansion-graph.md](the-layer-above-and-the-expansion-graph.md) — **the stack (kcp + Flux + Argo CD above this operator), the expansion graph, and what kcp does and does not solve** |
