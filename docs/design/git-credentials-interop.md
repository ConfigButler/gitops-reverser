...
([gittarget_types.go](../../api/v1alpha3/gittarget_types.go)) advertise a Flux `GitRepository`:
...
In [gittarget_types.go](../../api/v1alpha3/gittarget_types.go), remove every trace of Flux from
