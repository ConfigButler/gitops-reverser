...
> Related: [manifestedit-abstraction-plan.md](../design/manifest/manifestedit-abstraction-plan.md),
...
- [x] **3.1 Fix status contradiction** —
  [manifestedit-integration-readonly-reconcile.md:3](../design/manifest/manifestedit-integration-readonly-reconcile.md):
...
- Spelling in [file-agnostic-placement.md](../design/manifest/file-agnostic-placement.md) and MD040
