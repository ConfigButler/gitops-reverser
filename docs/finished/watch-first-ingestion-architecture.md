...
> [Mutation Capture Lab](../spec/mutation-capture-lab-design.md),
> [API-source-of-truth reconcile](../architecture.md),
...
| internal/gate | **CUT** | Demand-gating existed to bound the per-type mirror. No mirror, no gate. |
