...
* **git:** stop fetching before every publication, measured end to end ([#382](https://github.com/ConfigButler/gitops-reverser/issues/382)) ([9535d6a](https://github.com/ConfigButler/gitops-reverser/commit/9535d6a869add646d7b6233164ee9fe8feaa4159))
* revert refused edits with an empty commit, and bound base trust ([#383](https://github.com/ConfigButler/gitops-reverser/issues/383)) ([d9e1573](https://github.com/ConfigButler/gitops-reverser/commit/d9e15737b7f74b8763425ce7154d04b86f1c1fc8))
...
* **api:** delete ClusterWatchRule scope, collapse every reference onto Flux's, and split the placement metric ([#333](https://github.com/ConfigButler/gitops-reverser/issues/333))
...
* **api:** delete ClusterWatchRule scope, collapse every reference onto Flux's, and split the placement metric ([#333](https://github.com/ConfigButler/gitops-reverser/issues/333)) ([f87e227](https://github.com/ConfigButler/gitops-reverser/commit/f87e2275eb2b619cd439e8e00adb52f5f313ff36))
...
* **placement:** register a new file with its nearest ancestor kustomization ([#319](https://github.com/ConfigButler/gitops-reverser/issues/319)) ([5b7536b](https://github.com/ConfigButler/gitops-reverser/commit/5b7536b89a2d412f4a80401f404a216e90a42366)), closes [#295](https://github.com/ConfigButler/gitops-reverser/issues/295)
...
* **e2e:** fail fast on a wedged cluster; devcontainer Git identity + SSH signing bootstrap ([#309](https://github.com/ConfigButler/gitops-reverser/issues/309)) ([03ab6c7](https://github.com/ConfigButler/gitops-reverser/commit/03ab6c7e20edd9600a602eb70f14dff8bb1e32af))
