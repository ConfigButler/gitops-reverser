...
The corollary is sharper. Authoring an `Application` for that path *as well* — which
...
this shape, both available moves are wrong: author the CR and you get a duplicate
that fights the generator; omit it and — in every *other* layout — nothing deploys.
