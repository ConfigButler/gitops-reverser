...
| 1-desired-state/argocd-plain | 0 | Partial | 1 | 1 | plain=2 | - | non-krm-yaml [fixable]: ci-metadata.yaml: YAML is not a Kubernetes manifest |
...
| 2-rendered/kustomize-overlays | 0 | Partial | 1 | 3 | kustomize-single=1, refused-structural=3 | configMapGenerator, namePrefix, nameSuffix, remote-base, secretGenerator | refused-structural [pending-upstream]: kustomization uses unsupported feature(s): remote-base<br>refused-structural [permanent]: kustomization uses unsupported feature(s): configMapGenerator, nameSuffix, secretGenerator<br>refused-structural [permanent]: kustomization uses unsupported feature(s): configMapGenerator, namePrefix |
| 2-rendered/rendered-manifests | 0 | Partial | 3 | 2 | plain=3, refused-structural=2 | namePrefix | refused-structural [permanent]: kustomization uses unsupported feature(s): namePrefix<br>refused-structural [permanent]: kustomization uses unsupported feature(s): namePrefix |
| 3-expanded/argocd-applicationset-directories | 0 | All reported candidates accepted | 5 | 0 | plain=5 | - | None |
| 3-expanded/argocd-applicationset-files | 0 | No reported candidates accepted | 0 | 1 | plain=1 | - | non-krm-yaml [fixable]: chart/Chart.yaml: YAML is not a Kubernetes manifest<br>foreign-file [fixable]: chart/templates/_helpers.tpl: foreign file chart/templates/_helpers.tpl is not a managed manifest; remove it or name it in .gittargetignore<br>non-krm-yaml [fixable]: chart/templates/deployment.yaml: YAML is not a Kubernetes manifest<br>non-krm-yaml [fixable]: chart/templates/service.yaml: YAML is not a Kubernetes manifest<br>+5 more |
| 3-expanded/argocd-multicluster-matrix | 0 | All reported candidates accepted | 4 | 0 | plain=4 | - | None |
| 3-expanded/flux-helmrelease | 0 | Partial | 3 | 1 | kustomize-single=3, refused-structural=1 | configMapGenerator | refused-structural [permanent]: kustomization uses unsupported feature(s): configMapGenerator |
...
| 6-hostile/mixed-and-hostile | 0 | Partial | 3 | 2 | plain=4, refused-structural=1 | unparseable | refused-structural [fixable]: kustomization uses unsupported feature(s): unparseable (invalid Kustomization: json: unknown field "spec")<br>impure-managed-file [fixable]: bundle.yaml: a file with managed resources may contain only valid KRM documents; document #1 is a non-KRM document<br>impure-managed-file [fixable]: bundle.yaml: a file with managed resources may contain only valid KRM documents; document #2 is an empty document<br>foreign-file [fixable]: deployment.json: foreign file deployment.json is not a managed manifest; remove it or name it in .gittargetignore |
...
| Candidate | Layout | Accepted today | Namespace | rendered/editable/non-KRM | Refusal reasons |
|---|---|---|---|---|---|
| `apps/frontend` | `plain` | false | `frontend` | 6/6/1 | non-krm-yaml [fixable]: ci-metadata.yaml: YAML is not a Kubernetes manifest |
...
| `apps/backend/overlays/production` | `refused-structural` | false | `backend-production` | 0/0/0 | refused-structural [pending-upstream]: kustomization uses unsupported feature(s): remote-base |
| `apps/frontend/overlays/production` | `refused-structural` | false | `frontend-production` | 2/0/3 | refused-structural [permanent]: kustomization uses unsupported feature(s): configMapGenerator, nameSuffix, secretGenerator |
| `apps/frontend/overlays/staging` | `refused-structural` | false | `frontend-staging` | 2/0/1 | refused-structural [permanent]: kustomization uses unsupported feature(s): configMapGenerator, namePrefix |
...
| `src/frontend/overlays/production` | `refused-structural` | false | `frontend-production` | 2/0/0 | refused-structural [permanent]: kustomization uses unsupported feature(s): namePrefix |
| `src/frontend/overlays/staging` | `refused-structural` | false | `frontend-staging` | 2/0/0 | refused-structural [permanent]: kustomization uses unsupported feature(s): namePrefix |
...
| Candidate | Layout | Accepted today | Namespace | rendered/editable/non-KRM | Refusal reasons |
|---|---|---|---|---|---|
| `.` | `plain` | false | `argocd` | 1/1/9 | non-krm-yaml [fixable]: chart/Chart.yaml: YAML is not a Kubernetes manifest<br>foreign-file [fixable]: chart/templates/_helpers.tpl: foreign file chart/templates/_helpers.tpl is not a managed manifest; remove it or name it in .gittargetignore<br>non-krm-yaml [fixable]: chart/templates/deployment.yaml: YAML is not a Kubernetes manifest<br>non-krm-yaml [fixable]: chart/templates/service.yaml: YAML is not a Kubernetes manifest<br>non-krm-yaml [fixable]: chart/values.yaml: YAML is not a Kubernetes manifest<br>non-krm-yaml [fixable]: deployments/dev/backend.yaml: YAML is not a Kubernetes manifest<br>non-krm-yaml [fixable]: deployments/dev/frontend.yaml: YAML is not a Kubernetes manifest<br>non-krm-yaml [fixable]: deployments/production/backend.yaml: YAML is not a Kubernetes manifest<br>non-krm-yaml [fixable]: deployments/production/frontend.yaml: YAML is not a Kubernetes manifest |
...
| Candidate | Layout | Accepted today | Namespace | rendered/editable/non-KRM | Refusal reasons |
|---|---|---|---|---|---|
| `apps/frontend` | `refused-structural` | false | `-` | 1/1/1 | refused-structural [permanent]: kustomization uses unsupported feature(s): configMapGenerator |
| `clusters/production` | `kustomize-single` | true | `flux-system` | 7/7/0 | none |
...
| Candidate | Layout | Accepted today | Namespace | rendered/editable/non-KRM | Refusal reasons |
|---|---|---|---|---|---|
| `.` | `refused-structural` | false | `backend` | 0/0/5 | refused-structural [fixable]: kustomization uses unsupported feature(s): unparseable (invalid Kustomization: json: unknown field "spec") |
| `crossplane` | `plain` | true | `-` | 1/1/0 | none |
| `kro` | `plain` | true | `-` | 1/1/0 | none |
| `mixed` | `plain` | false | `-` | 3/3/2 | impure-managed-file [fixable]: bundle.yaml: a file with managed resources may contain only valid KRM documents; document #1 is a non-KRM document<br>impure-managed-file [fixable]: bundle.yaml: a file with managed resources may contain only valid KRM documents; document #2 is an empty document<br>foreign-file [fixable]: deployment.json: foreign file deployment.json is not a managed manifest; remove it or name it in .gittargetignore |
